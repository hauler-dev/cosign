...
func LoadCmd(ctx context.Context, opts options.LoadOptions, imageRef string) error {
	...
	if opts.Registry.Name == "" {
		return remote.WriteSignedImageIndexImages(ref, loadTags, sii, opts.Directory, ociremoteOpts...)
	}
	return remote.WriteSignedImageIndexImagesBulk(ref, opts.Registry.Name, loadTags, sii, opts.Directory, ociremoteOpts...)
}
